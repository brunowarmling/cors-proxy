...
function parseURL(req_url) {
  ...
  if(req_url.includes('/.well-known/vercel')){
	  console.log('antes', req_url);
	  req_url = req_url.replace('http://.well-known/vercel', 'https://app.wedy.com/.well-known/vercel');
	  console.log('depois', req_url);
  }
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
	...
	req.url = req.url.replace('https:/app.wedy', 'https://app.wedy')
    ...
    var origin = req.headers.origin || 'https://sites.wedy.com';
